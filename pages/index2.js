...
const Index2Page = () => {
        ...
        const items = list
          ...
          .map((item) => {
            ...
            return {
              ...
              locationTitle:
                scenarioLocationTitleByKey[locationKey] ||
                scenarioLocationTitleByKey[selectedScenarioLocation] ||
                '',
              isPast,
            }
          })
          .filter((item) => item.id && item.image && item.isPast)
  ...
  const getNearestPointId = (x, y) => {
    ...
    return minDistance <= 28 ? nearest : null
  }
          ...
          <section className="relative z-10 flex items-center w-full max-w-3xl min-h-screen px-6 mx-auto">
            {riddlePhase === 'question' && (
              ...
              >
                ...
                {riddleError && (
                  <p className="typewriter-machine mt-5 whitespace-pre-line text-sm leading-relaxed text-[#ffb0b0]">
                    {riddleError}
                  </p>
                )}
          ...
          <main className="relative z-10 pb-20 main-enter">
            ...
            <section className="grid w-full max-w-6xl gap-8 px-4 mx-auto reveal-b pt-14 lg:grid-cols-12 xl:gap-10">
              ...
              <div className="lg:col-span-5 lg:pt-8">
                ...
                {gameComplete && (
                  <div className="mt-3 rounded-xl border border-[#00D1FF]/30 bg-[#00D1FF]/10 px-4 py-3 text-sm text-[#c8f8ff]">
                    ты ищешь быстрее, чем остальные
                    <br />
