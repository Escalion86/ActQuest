...
const gamesTeamsSchema = {
  ...
  storyProgress: {
    type: {
      ...
      unlockedCharacterIds: { type: [String], default: [] },
      unlockedTopicIds: { type: [String], default: [] },
      usedInteractionIds: { type: [String], default: [] },
        ...
        type: [
          {
            ...
            interactionId: { type: String, trim: true, default: null },
            kind: {
              type: String,
            ...
            evidenceId: { type: String, trim: true, default: null },
            discoveredAtMinute: { type: Number, default: 0, min: 0 },
      ...
      accusation: {
        type: {
          ...
          submittedAtMinute: { type: Number, default: null, min: 0 },
          culpritId: { type: String, trim: true, default: null },
          motiveId: { type: String, trim: true, default: null },
          evidenceIds: { type: [String], default: [] },
          outcomeId: { type: String, trim: true, default: null },
        },
        default: () => ({}),
      },
      history: {
        type: [
          {
            ...
            toNodeId: { type: String, trim: true, default: null },
