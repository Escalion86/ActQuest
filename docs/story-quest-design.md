...
Для MVP концовки достигаются явно через код, действие или ручное завершение организатором. Автоматический выбор концовки по баллам можно добавить вторым этапом.
