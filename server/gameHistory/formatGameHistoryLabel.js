const EXACT_LABELS = new Map([
  ...
  ['game.allowJoinAfterStart', 'Присоединение после запуска'],
  ['game.recordsVisibility', 'Видимость рекордов'],
  ['game.recordsShowNames', 'Имена в рекордах'],
...
const SEGMENT_LABELS = new Map([
  ...
  ['allowJoinAfterStart', 'Присоединение после запуска'],
  ['recordsVisibility', 'Видимость рекордов'],
  ['recordsShowNames', 'Имена в рекордах'],
