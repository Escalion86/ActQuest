...
const GameEditModal = ({
  ...
  const prequelHasDescription =
    ...
    hasMeaningfulRichMarkup(prequel.descriptionRich) ||
  ...
  const getPrequelCodeAccordionKey = (kind, index) =>
    `prequel-${kind}-${index}`
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <CabinetButton
            onClick={() => {
              ...
              const nextAccordionKey = getPrequelCodeAccordionKey(kind, nextIndex)
            ...
            {items.map((item, itemIndex) => {
              ...
              return (
                <details
                  ...
                  className="relative overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 p-2 dark:border-slate-700 dark:bg-slate-800/60"
                >
                  <summary className="w-full max-w-full list-none overflow-hidden rounded-xl text-sm font-medium text-slate-700 marker:content-none dark:text-slate-100">
                    <div
                    ...
                    <div className="grid w-full max-w-full cursor-pointer grid-cols-[minmax(0,1fr)_auto] items-center gap-2 px-2 py-1">
                      <div className="mt-2 flex min-w-0 w-full items-center gap-2 overflow-hidden">
  ...
  }, [selectedGame?.id, isEditModalOpen])
  ...
  const prequelEditorSection = (
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white transition dark:border-slate-700 dark:bg-slate-900/70">
      <div className="flex w-full items-stretch bg-slate-50 dark:bg-slate-800/70">
        ...
        <div className="flex items-center shrink-0 px-4 border-l border-slate-200 dark:border-slate-700">
          <NeonCheckbox
      ...
      >
        ...
        {isTasksOnly && (
          <ModalSection>
            ...
            <div className="mt-4">{prequelEditorSection}</div>
