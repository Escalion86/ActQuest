          ...
          >
            <fieldset disabled={isCreatingGame} className="m-0 space-y-5 border-0 p-0">
              <p className="text-sm text-slate-600 dark:text-slate-300">
                Можно создать пустую игру или взять за основу существующую и скопировать нужные блоки.
              </p>
              <div className="space-y-3 rounded-2xl border border-slate-200 p-4 dark:border-slate-700">
                <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Способ создания</p>
              ...
              {createGameMode === 'clone' && (
                <div className="space-y-4 rounded-2xl border border-slate-200 p-4 dark:border-slate-700">
                  <div className="space-y-2">
                    ...
                    >
                      <option value="">
                        {isCloneSourceGamesLoading ? 'Загружаем игры…' : 'Выберите игру'}
                      </option>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <NeonCheckbox
                        ...
                        onChange={(event) => onCloneOptionChange('basic', event.target.checked)}
                      ...
                      <NeonCheckbox
                        ...
                        onChange={(event) => onCloneOptionChange('rules', event.target.checked)}
                      ...
                      <NeonCheckbox
                        ...
                        onChange={(event) => onCloneOptionChange('captainRules', event.target.checked)}
                      ...
                      <NeonCheckbox
                        ...
                        onChange={(event) => onCloneOptionChange('tasks', event.target.checked)}
                        label="Задания"
                        className="w-full"
                        labelClassName="text-sm text-slate-600 dark:text-slate-200"
                      />
                      <NeonCheckbox
                        ...
                        onChange={(event) => onCloneOptionChange('locations', event.target.checked)}
                      ...
                      <NeonCheckbox
                        ...
                        onChange={(event) => onCloneOptionChange('moderators', event.target.checked)}
                        label="Модераторов"
                        className="w-full"
                        labelClassName="text-sm text-slate-600 dark:text-slate-200"
                      />
                      <NeonCheckbox
                        ...
                        onChange={(event) => onCloneOptionChange('publication', event.target.checked)}
                      ...
                      <NeonCheckbox
                        ...
                        onChange={(event) => onCloneOptionChange('prices', event.target.checked)}
              ...
              {Boolean(newGameIsRated) && (
                <div className="space-y-2 rounded-2xl border border-slate-200 p-4 dark:border-slate-700">
                  ...
                  <div className="flex flex-col gap-2 sm:flex-row">
                    <select
                      id="new-game-season"
                      value={createGameSeasonId}
                      onChange={(event) => setCreateGameSeasonId(event.target.value)}
                      disabled={isCreateGameSeasonsLoading || !createGameLocation}
                      className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-200"
                    >
                      <option value="">
                    ...
                    <button
                      type="button"
                      onClick={handleCreateSeasonForCreateGame}
                      disabled={!createGameLocation || isCreateGameSeasonCreating}
                      className="aq-modal-btn aq-modal-btn-secondary whitespace-nowrap"
                    >
                      {isCreateGameSeasonCreating ? 'Создание…' : 'Создать сезон'}
                    </button>
                  </div>
                </div>
              )}
