...
const AdminTransactionsPage = ({
  ...
  const reload = useCallback(async () => {
    ...
    const { json } = await requestApiJson(`${CABINET_ADMIN_API_BASE}/transactions?${query}`, {
  ...
  const createTransaction = useCallback(async () => {
    ...
    try {
      ...
      const request = isCouponFlow && basePayload.couponCode && !basePayload.gameId
        ? {
            url: `${CABINET_ADMIN_API_BASE}/transactions/coupon/issue`,
            data: {
        ...
        : isCouponFlow && basePayload.couponCode && basePayload.gameId
          ? {
              url: `${CABINET_ADMIN_API_BASE}/transactions/coupon/redeem`,
              data: {
                userId: basePayload.userId,
          ...
          : { url: `${CABINET_ADMIN_API_BASE}/transactions`, data: basePayload }
  ...
  const removeTransaction = useCallback(
    async (id) => {
      ...
      setFeedback(null)
      try {
        await requestApiJson(`${CABINET_ADMIN_API_BASE}/transactions/${id}`, {
          method: 'DELETE',
