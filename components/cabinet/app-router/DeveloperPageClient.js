    ...
    <>
      ...
      >
        ...
        <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900/80">
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
            Пересчитывает рейтинг V2 всех игроков и команд по закрытым
            рейтинговым играм: общий snapshot и отдельный рейтинг за всё время
            для каждого города. Затем обновляет данные в базе.
          </p>
          <div className="mt-4">
            <CabinetButton
